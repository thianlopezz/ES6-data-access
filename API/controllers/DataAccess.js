      ...
      connection
        ...
        .then(conn => {
          ...
          conn.query(exec, function(error, result) {
            ...
            if (error) {
              console.log(
                'Error>> Metodo: "execJsonToSp", "con.query">> ' + error
              );
              reject(error);
            } else {
              resolve(result);
        ...
        .catch(error => {
          console.log(
            'Error>> Metodo: "execJsonToSp", "connection.acquire">> ' + error
          );
          reject(error);
        });
    });
      ...
      connection
        ...
        .then(conn => {
          ...
          conn.query(exec, function(error, result) {
            ...
            if (error) {
              console.log(
                'Error>> Metodo: "execArrayToSp", "con.query">> ' + error
              );
              reject(error);
            } else {
              resolve(result);
        ...
        .catch(error => {
          console.log(
            'Error>> Metodo: "execArrayToSp", "connection.acquire">> ' + error
          );
          reject(error);
        });
    });
      ...
      connection
        ...
        .then(conn => {
          ...
          conn.query(sql, function(error, result) {
            ...
            if (error) {
              console.log(
                'Error>> Metodo: "execQuery", "con.query">> ' + error
              );
              reject(error);
            } else {
              resolve(result);
        ...
        .catch(error => {
          console.log(
            'Error>> Metodo: "execQuery", "connection.acquire">> ' + error
          );
          reject(error);
        });
    });
